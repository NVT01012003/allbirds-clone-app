...
function TopNavigation() {
    ...
    const handleScroll = () => {
        ...
        if (y >= 40 && scrolling.current) {
            scrolling.current = false;
            navigationBar.current.setAttribute("id", "hide");
        } else if (y < 40 && !scrolling.current) {
            scrolling.current = true;
            navigationBar.current.setAttribute("id", "show");
        }
    };
    ...
    return (
        <div
            ...
            id={scrolling.current ? "show" : "hide"}
            ref={navigationBar}
        >
            ...
            <div className="navigation-bar">
                ...
                <div className="navigation-bar_item">
                    ...
                    >
                        <title>Search</title>
                        <path
                            d="M10.4713 17.9427C14.5977 17.9427 17.9427 14.5977 17.9427 10.4713C17.9427 6.34503 14.5977 3 10.4713 3C6.34503 3 3 6.34503 3 10.4713C3 14.5977 6.34503 17.9427 10.4713 17.9427Z"
                            stroke="black"
                            strokeWidth="2"
                            strokeLinecap="round"
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <text x="14" y="12" textAnchor="middle" width="100%">
                            0
                        </text>
                        <path
